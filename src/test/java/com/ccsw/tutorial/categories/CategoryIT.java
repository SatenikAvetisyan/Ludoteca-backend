...
public class CategoryIT {
    ...
    @Test
    public void findAllShouldReturnAllCategory() {
    ...
    public void modifyWithExistIdShouldModifyCategory() {
        ...
        CategoryDto clientsSearch = response.getBody().stream().filter(item -> item.getId().equals(MODIFY_CATEGORY_ID)).findFirst().orElse(null);
        assertNotNull(clientsSearch);
        assertEquals(NEW_CATEGORY_NAME, clientsSearch.getName());
    }
